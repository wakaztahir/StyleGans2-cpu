...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='factorvae_dsprites_scalorixy',  func_name='metrics.factor_vae_metric.FactorVAEMetric',     dataset_dir='/mnt/hdd/Datasets/dsprites/dsprites_scalorixy_noshuffle_tfr', use_latents='[1,2,3,4]', batch_size=60, num_train=10000, num_eval=5000, num_variance_estimate=10000),
]])
