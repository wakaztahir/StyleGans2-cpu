...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='factorvae_dsprites_all_hpc_vae',  func_name='metrics.factor_vae_metric.FactorVAEMetric',     dataset_dir='/project/xqzhu/disentangle_datasets/dsprites/dsprites_all_noshuffle_tfr', dataset_name='Dsprites', use_latents='[0,1,2,3,4]', batch_size=60, num_train=10000, num_eval=5000, num_variance_estimate=10000, has_label_place=True),
