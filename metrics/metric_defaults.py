...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='factorvae_dsprites_all_vae',  func_name='metrics.factor_vae_metric.FactorVAEMetric',     dataset_dir='/mnt/hdd/Datasets/dsprites/dsprites_all_noshuffle_tfr', dataset_name='Dsprites', use_latents='[0,1,2,3,4]', batch_size=60, num_train=10000, num_eval=5000, num_variance_estimate=10000, has_label_place=True, drange_net=[0., 1.]),
    EasyDict(name='group_verify', func_name='metrics.group_verify.GVerify'),
    ...
    EasyDict(name='factorvae_dsprites_all_devcube2_vae',  func_name='metrics.factor_vae_metric.FactorVAEMetric',     dataset_dir='/home/xqzhu/disentangle_datasets/dsprites/dsprites_all_noshuffle_tfr', dataset_name='Dsprites', use_latents='[0,1,2,3,4]', batch_size=60, num_train=10000, num_eval=5000, num_variance_estimate=10000, has_label_place=True, drange_net=[0., 1.]),
    EasyDict(name='factorvae_dsprites_all_devbox_vae',  func_name='metrics.factor_vae_metric.FactorVAEMetric',     dataset_dir='/home/xqzhu/disentangle_datasets/dsprites/dsprites_all_noshuffle_tfr', dataset_name='Dsprites', use_latents='[0,1,2,3,4]', batch_size=60, num_train=10000, num_eval=5000, num_variance_estimate=10000, has_label_place=True, drange_net=[0., 1.]),
    ...
    EasyDict(name='factorvae_dsprites_scalorixy_vae',  func_name='metrics.factor_vae_metric.FactorVAEMetric',     dataset_dir='/mnt/hdd/Datasets/dsprites/dsprites_scalorixy_noshuffle_tfr', dataset_name='Dsprites', use_latents='[1,2,3,4]', batch_size=60, num_train=10000, num_eval=5000, num_variance_estimate=10000, has_label_place=True, drange_net=[0., 1.]),
    ...
    EasyDict(name='factorvae_shape3d_all_vae',  func_name='metrics.factor_vae_metric.FactorVAEMetric',     dataset_dir='/mnt/hdd/Datasets/shapes_3d/shape3d_all_noshuffle_tfr', dataset_name='3DShapes', use_latents='[0,1,2,3,4,5]', batch_size=60, num_train=10000, num_eval=5000, num_variance_estimate=10000, has_label_place=True, drange_net=[0., 1.]),
    EasyDict(name='factorvae_shape3d_all_devcube2_vae',  func_name='metrics.factor_vae_metric.FactorVAEMetric',     dataset_dir='/lshare/xqzhu/Datasets/Shapes3d/shape3d_all_noshuffle_tfr', dataset_name='3DShapes', use_latents='[0,1,2,3,4,5]', batch_size=60, num_train=10000, num_eval=5000, num_variance_estimate=10000, has_label_place=True, drange_net=[0., 1.]),
